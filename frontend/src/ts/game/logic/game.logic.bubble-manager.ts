...
const orange: Bubble = {
    ascii: `<div class="field bubble" style="background: rgb(255, 166, 65); border-color: rgb(255, 166, 65);"></div>`,
    type: 1,
}
const yellow: Bubble = {
...
const green: Bubble = {
    ascii: `<div class="field bubble" style=" background: rgb(34, 211, 28); border-color: rgb(34, 211, 28);"></div>`,
    type: 3,
}
const cyan: Bubble = {
